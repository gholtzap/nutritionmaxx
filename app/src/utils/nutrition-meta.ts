import type { NutrientKey, NutrientGroup, FruitCategory, VegetableCategory, SpiceCategory, NutSeedCategory, LegumeCategory, GrainCategory, FishSeafoodCategory, PoultryCategory, BeefCategory, PorkCategory, ItemCategory } from '../types';
...
export const CATEGORY_COLORS: Record<string, string> = {
  ...
  'Tree Nut': 'var(--cat-tree-nut)',
  'Legume Nut': 'var(--cat-legume-nut)',
  Bean: 'var(--cat-bean)',
  ...
  Steak: 'var(--cat-steak)',
  'Other Cut': 'var(--cat-other-cut)',
  Loin: 'var(--cat-loin)',
  Shoulder: 'var(--cat-shoulder)',
  Other: 'var(--cat-other)',
};
...
export const NUT_SEED_CATEGORIES: NutSeedCategory[] = [
  'Tree Nut', 'Seed', 'Legume Nut',
];

export const LEGUME_CATEGORIES: LegumeCategory[] = [
  'Bean', 'Lentil', 'Pea', 'Soy',
];
...
export const FISH_SEAFOOD_CATEGORIES: FishSeafoodCategory[] = [
...
export const BEEF_CATEGORIES: BeefCategory[] = [
  'Ground', 'Steak', 'Other Cut',
];

export const PORK_CATEGORIES: PorkCategory[] = [
  'Loin', 'Shoulder', 'Other Cut',
];
