export type ItemType = 'fruit' | 'vegetable' | 'spice' | 'nut_seed' | 'legume';
...
export type ItemCategory = FruitCategory | VegetableCategory | SpiceCategory | NutSeedCategory | LegumeCategory;
